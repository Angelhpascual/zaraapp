...
export const updateProductUseCase = new CreateProductUseCase(productRepository)
export const deleteProductUseCase = new CreateProductUseCase(productRepository)
